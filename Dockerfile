...
LABEL org.opencontainers.image.title="semrel-plugin-condition-bitbucket-pipelines" \
      org.opencontainers.image.description="semrel plugin: condition-bitbucket-pipelines" \
      org.opencontainers.image.url="https://semrel.io" \
      org.opencontainers.image.source="https://github.com/SemRels/condition-bitbucket-pipelines" \
